...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:popped_chorus_fruit{display:{Name:'{"text":"Enchanted Popped Chorus Fruit","color":"dark_purple","bold":true,"italic":false}'}, chorus:2,Enchantments: [{}]}
...
playsound entity.enderman.ambient master @a[distance=0..6] ~ ~ ~ 1 1