...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:elytra{display:{Name:'{"text":"Fractured OP Wings","color":"dark_purple","italic":false}'}, Damage:431,Enchantments:[{}],chorus:4}
