...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:chorus_fruit{display:{Name:'{"text":"Enchanted Chorus Fruit","color":"dark_purple","bold":true,"italic":false}'}, chorus:1,Enchantments: [{}]}
