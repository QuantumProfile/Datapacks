...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:iron_shovel{display:{Name:'{"text":"Helper Tool"}'}, helper_tool:1,Enchantments: [{id:"minecraft:efficiency",lvl:1000000000},{id:"minecraft:unbreaking",lvl:8}]}
...
playsound entity.player.levelup master @a[distance=0..6] ~ ~ ~ 1 1