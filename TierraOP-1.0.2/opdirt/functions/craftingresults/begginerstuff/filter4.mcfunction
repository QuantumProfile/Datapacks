...
execute at @s run replaceitem block ~ ~ ~ container.7 minecraft:bowl{display:{Name:'{"text":"Filter","italic":false}'},filter:1} 8
execute at @s run replaceitem block ~ ~ ~ container.5 minecraft:air
execute at @s run replaceitem block ~ ~ ~ container.6 minecraft:air
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:cobweb 16
