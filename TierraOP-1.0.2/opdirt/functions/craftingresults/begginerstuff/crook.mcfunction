...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:wooden_hoe{display:{Name:'{"text":"Crook","color":"white","italic":false}'}, crook:1}
...
playsound block.wood.break master @a[distance=0..6] ~ ~ ~ 1 1