...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:potion{display:{Name:'{"text":"Golden Deeps Incantation","color":"#990000","bold":true,"italic":false}',Lore:['{"text":"This Potion teleports you to the gold dimension"}']},Potion:"minecraft:water",CustomPotionColor:14399232,potion:1} 1
...
playsound block.brewing_stand.brew master @a[distance=0..6] ~ ~ ~ 1 1