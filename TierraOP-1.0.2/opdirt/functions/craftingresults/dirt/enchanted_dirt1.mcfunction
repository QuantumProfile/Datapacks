...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:dirt{display:{Name:'{"text":"Enchanted Dirt","color":"#7A4F04","bold":true,"italic":false}'},Enchantments:[{}], dirt:1} 7
