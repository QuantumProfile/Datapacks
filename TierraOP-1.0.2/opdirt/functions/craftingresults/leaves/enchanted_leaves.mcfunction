...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:oak_leaves{display:{Name:'{"text":"Enchanted Leaves","color":"#2F8000","bold":true,"italic":false}'},Enchantments:[{}],leaves:1}
