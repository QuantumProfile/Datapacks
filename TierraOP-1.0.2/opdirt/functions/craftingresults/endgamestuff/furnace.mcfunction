...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:furnace{display:{Name:'{"text":"Super Furnace","color":"dark_gray","bold":true,"italic":false}'},Enchantments:[{}],cobble:4}
