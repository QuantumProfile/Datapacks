...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:gold_nugget{display:{Name:'{"text":"Enchanted Gold Nugget","color":"#DBB700","bold":true,"italic":false}'}, tag:{goldnugget:1},Enchantments:[{}]} 3
...
playsound block.enchantment_table.use master @a[distance=0..6] ~ ~ ~ 1 1