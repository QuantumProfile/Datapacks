...
execute at @s run replaceitem block ~ ~ ~ container.4 minecraft:cobweb{display:{Name:'{"text":"Super Cobweb","color":"white","italic":false,"bold":true}'}, string:2,Enchantments: [{}]}
